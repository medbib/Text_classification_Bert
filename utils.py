...
class ComplaintsDataset(Dataset):
    def __init__(self, data_mode="train", 
                 ...
                 classes=list((('Credit reporting, credit repair services, or other personal consumer reports', 'Credit reporting'),
                               ('Debt collection', 'Medical'), 
                               ('Debt collection', 'Mortgage debt'),
                               ('Debt collection', 'Student loan'), 
                               ('Debt collection', 'Other debt'),
                               ('Card', 'Store credit card'), 
                               ...
                               ('Bank account or service', 'Money transfer'),
                               ...
                               ('Card', 'Other special purpose card'),
                               ('Debt collection', 'Vehicle loan'),
                               ('Debt collection', 'Installment loan'),
                               ('Bank account or service', 'Mobile or digital wallet'),
                               ('Bank account or service', 'Virtual currency'),
                               ('Bank account or service', 'Other debt'), 
                               ('Card', 'Credit card'),
